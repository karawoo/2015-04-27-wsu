...
> ### Challenge {.challenge}
>
> Explore the distribution of the population sizes of counties, by
> continent.
...
Explain the use of `ggsave`.

* last plot vs plot saved in some object
* height and width in inches
* file type taken from file extension
